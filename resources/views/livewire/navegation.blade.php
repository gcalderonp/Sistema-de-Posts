    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <div class="ml-3 relative" x-data="{open: false}">
                        ...
                        <div x-show="open" x-on:click.away="open=false"
                            ...
                            <a href="{{ route('profile.show') }}" class="block px-4 py-2 text-sm text-gray-700"
                                ...
                                role="menuitem" tabindex="-1" id="user-menu-item-0">Adminnistrador</a>
                                @endcan
                ...
                @else
                    <div>
                        <a href="{{ route('login') }}" class="hover:bg-gray-700 rounded-md inline-block px-4 py-2 text-sm text-gray-200"
                            role="menuitem" tabindex="-1" id="user-menu-item-2">Login</a>
                        <a href="{{ route('register') }}" class="hover:bg-gray-700 rounded-md inline-block px-4 py-2 text-sm text-gray-200"
